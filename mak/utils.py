...
def generate_config_simulation(c_id):
    ...
    with open(file=yaml_file) as file:
        try:
            ...
            simu_config['gpu'] = config['client']['gpu']
            simu_config['num_cpus'] = config['client']['num_cpus']
            simu_config['num_gpus'] = config['client']['num_gpus']
