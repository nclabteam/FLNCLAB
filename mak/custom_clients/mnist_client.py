...
class MnistClient(fl.client.NumPyClient):
    """Flower NumPy Client implementing MNIST image classification."""
    def __init__(
        self,
    ...
    def evaluate(self, parameters, config):
        self.model.set_weights(parameters)
        print("Inside evalvate MNIST Client")
        loss, accuracy = self.model.evaluate(self.x_test, self.y_test, verbose=1)
        print("Eval accuracy on MNIST Client {} : {}".format(self.client_name,accuracy))
