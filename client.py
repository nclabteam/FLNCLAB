...
def main() -> None:
    ...
    if data_type == "one-class-niid":
        ...
        (x_train, y_train), (x_test, y_test) = fashion_mnist_data_obj.load_data_one_class(
        ...
        (x_train, y_train), (x_test, y_test) = fashion_mnist_data_obj.load_data_majority_class(
        ...
        (x_train, y_train), (x_test, y_test) = fashion_mnist_data_obj.load_data_two_classes(
            class_1=class_1, class_2=class_2)
    else:
        print("Using Default IID Settings")
        (x_train, y_train), (x_test, y_test) = fashion_mnist_data_obj.load_data_iid(
